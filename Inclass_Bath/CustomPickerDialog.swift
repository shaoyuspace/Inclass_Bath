...
class CustomPickerDialog: UIView {
    ...
    typealias CustomPickerCallback = (result: Class_Time) -> Void
    ...
    // data
    private var dataSelcted: Class_Time?
    private var dataSource = [Class_Time]()
    ...
    // MARK: public func
    func setDataSource(source: [Class_Time]) {
...
extension CustomPickerDialog: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusingView view: UIView?) -> UIView
    {
        ...
        lable.text=(dataSource[row].name+dataSource[row].getstime_string()+"-"+dataSource[row].getetime_string() )as String
